...
int lidar_type, pcd_save_interval, lidar_qos_depth, imu_qos_depth;
...
double time_lag_imu_to_lidar = 0.0, imu_buffer_seconds = 3.0, imu_expected_frequency_hz = 200.0;
...
void readParameters(shared_ptr<rclcpp::Node> &nh) {
    ...
    nh->declare_parameter<int>("communication.lidar_qos_depth", 5);
    nh->declare_parameter<int>("communication.imu_qos_depth", 0);
    nh->declare_parameter<double>("communication.imu_buffer_seconds", 3.0);
    nh->declare_parameter<double>("communication.imu_expected_frequency_hz", 200.0);
    ...
    nh->get_parameter("communication.lidar_qos_depth", lidar_qos_depth);
    nh->get_parameter("communication.imu_qos_depth", imu_qos_depth);
    nh->get_parameter("communication.imu_buffer_seconds", imu_buffer_seconds);
    nh->get_parameter("communication.imu_expected_frequency_hz", imu_expected_frequency_hz);
    lidar_qos_depth = std::max(1, lidar_qos_depth);
    imu_qos_depth = std::max(1, std::max(imu_qos_depth, static_cast<int>(std::ceil(imu_buffer_seconds * imu_expected_frequency_hz))));
