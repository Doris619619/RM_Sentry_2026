...
extern int lidar_type, pcd_save_interval, lidar_qos_depth, imu_qos_depth;
...
extern double time_lag_imu_to_lidar, imu_buffer_seconds, imu_expected_frequency_hz;

// 此函数用于声明、读取并校验 Point-LIO ROS2 参数；输入为节点参数服务，输出为算法和通信全局配置。
